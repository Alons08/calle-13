...
function submitOrder() {
    ...
    let message = `¡Hola Cevicheria Calle 13! Quiero realizar el siguiente pedido:\n\n`;
    ...
    const whatsappUrl = `https://wa.me/51904297545?text=${encodeURIComponent(message)}`; /*AQUI EL NUMERO*/
